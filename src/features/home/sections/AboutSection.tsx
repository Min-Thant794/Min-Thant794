      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="grid items-start gap-10 lg:grid-cols-5 lg:gap-16">
          <div className="lg:col-span-2">
            <h2 className="mb-8 flex flex-wrap items-center gap-4 font-headline text-3xl font-bold sm:text-4xl md:text-5xl">
          ...
          <div className="space-y-6 lg:col-span-3">
            <p className="text-base leading-relaxed text-on-surface-variant sm:text-lg md:text-xl">
